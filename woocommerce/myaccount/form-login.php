...
<div class="woocommerce-form-account" id="customer_login">

	<div class="column">

<?php endif; ?>

		<h2 class="heading heading__lg mb1"><?php esc_html_e( 'Login', 'woocommerce' ); ?></h2>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="column">
		...
		<h2 class="heading heading__lg mb1"><?php esc_html_e( 'Register', 'woocommerce' ); ?></h2>
